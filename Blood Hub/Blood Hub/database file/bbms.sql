...
--
-- Table structure for table `emergency_availability`
--
...
-- Dumping data for table `emergency_availability`
INSERT INTO `emergency_availability` (`id`, `name`, `blood_group`, `phone_number`, `address`, `email`) VALUES
(1, 'Emergency Donor 1', 'A+', 1234567890, '123 Main St', 'emergencydonor1@gmail.com'),
(2, 'Emergency Donor 2', 'B-', 9876543210, '456 Oak St', 'emergencydonor2@gmail.com');
...
--
-- Indexes for table `emergency_availability`
--
ALTER TABLE `emergency_availability`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `emergency_availability`
--
ALTER TABLE `emergency_availability`
